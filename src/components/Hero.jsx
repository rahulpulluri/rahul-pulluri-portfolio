      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            >
              I'm a <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500">Software Developer</span> currently pursuing a Master of Engineering in Computer Science at <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500">Virginia Tech</span>, with an expected graduation date in December 2024. I worked as a Full Stack/Data Engineer during my Summer Internship at Virginia Tech. Prior to my master's, I worked as an Associate Software Engineer at Accenture, where I enhanced full-stack applications and collaborated with teams to build scalable solutions. I also worked as a Software Developer Intern at iThink Logistics, where I helped improve system performance and developed features for mobile applications. My hands-on experience spans Full Stack Development, Data Engineering, and Cloud Computing, and I’m actively seeking full-time opportunities starting in January 2025.
            </motion.p>
          </div>
        </div>
